...
class TasksActivityTest {
    ...
    @Before
    fun init() {
        // initialize the repository using ServiceLocator's provideTasksRepository method
    ...
    fun editTask() = runBlocking {
        //todo: to check again
        /**
         *  Adding tasks to the repository, must happen before ActivityScenario.launch() is called.
         *  Calling such additional setup code, such as saving tasks to the repository,
         *  is not currently supported by ActivityScenarioRule.
